...
.. figure:: ../_static/prometheus-jg001.png
   :alt: 
...
.. figure:: ../_static/prometheus-web-ui01.png
   :alt: 
...
.. figure:: ../_static/prometheus-up01.png
   :alt: 

若点击“Graph”选项卡，则展示“UP”状态

.. figure:: ../_static/prometheus-up02.png
   :alt: 

最后，通过访问http://192.168.1.37:9090/targets地址，可以查看页面中的Targets信息

.. figure:: ../_static/prometheus-003.png
   :alt: 
...
**官方的Exporter列表中包含了常见的绝大多数系统监控指标，比如用于机器性能监控的node\_exporter，MySQL数据库监控的mysqld\_exporter，以及网络设备监控的snmp\_exporter等**\ 。这些已有的Exporter对于监控来说，只需进行很少的配置，就能提供完善的数据指标采集工作。
