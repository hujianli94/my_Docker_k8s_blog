...
::
    ...
    [root@ci-base helm_example]# helm create mychart
    Creating mychart
...
::
    ...
    [root@ci-base helm_example]# tree .
    .
    └── mychart
        ├── charts
        ├── Chart.yaml
...
::
    ...
    [root@ci-base helm_example]# rm -rf mychart/templates/*.*
...
::
    ...
    [root@ci-base helm_example]# helm install myapp ./mychart/ -n dev
    NAME: myapp
...
::
    ...
    [root@ci-base helm_example]# helm get manifest myapp -n dev
    ---
...
::
    ...
    [root@ci-base helm_example]# helm delete myapp -n dev
...
::
    ...
    [root@ci-base helm_example]# helm install clunky-serval ./mychart -n dev
    NAME: clunky-serval
...
::
    ...
    [root@ci-base helm_example]# helm get manifest clunky-serval  -n dev
    ---
    # Source: mychart/templates/configmap.yaml
    apiVersion: v1
    kind: ConfigMap
...
::
    ...
    [root@ci-base helm_example]# helm uninstall clunky-serval -n dev
    release "clunky-serval" uninstalled

    [root@ci-base helm_example]# helm install clunky-serval --debug --dry-run ./mychart -n dev
...
::
    ...
    [root@ci-base helm_example]# helm install myapp2021 --dry-run --debug ./mychart
    install.go:159: [debug] Original chart version: ""
    install.go:176: [debug] CHART PATH: /app/k8s_yaml/helm_example/mychart
...
::
    ...
    [root@ci-base helm_example]# helm install myapp2021 --dry-run --debug --set favoriteDrink=slurm ./mychart
    install.go:159: [debug] Original chart version: ""
    install.go:176: [debug] CHART PATH: /app/k8s_yaml/helm_example/mychart
...
::
    ...
    [root@ci-base helm_example]# tree demoapp
    demoapp
    ├── Chart.yaml
    ├── demoapp-values.yaml
    ├── README.md
...
::
    ...
    [root@ci-base helm_example]# helm lint demoapp
    ==> Linting demoapp
...
::
    ...
    [root@ci-base gitee_workspace_parallel]# helm package CI-gitee-helm/
...
::
    ...
    [root@ci-base gitee_workspace_parallel]# helm repo add gitee-helm http://hub.gitee.cc/chartrepo/gitee-helm
    "gitee-helm" has been added to your repositories

::

    [root@ci-base gitee_workspace_parallel]# helm repo list
    NAME            URL
    ingress-nginx   https://kubernetes.github.io/ingress-nginx
...
::
    ...
    [root@ci-base gitee_workspace_parallel]# helm plugin install https://github.com/chartmuseum/helm-push
...
::
    ...
    # 查看某Release的相关状态信息
    [root@ci-base helm_example]# helm status ci-gitee-release -n ci-gitee-release
